...
class ClientTrackerScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final totalCount = allAsync.whenOrNull(
            data: (list) =>
                list.where((c) => c.status != ClientStatus.churned).length) ??
        0;
    ...
    return Scaffold(
      ...
      body: SafeArea(
            ...
            child: Row(children: [
              ...
              Expanded(
                  child: Column(
                    ...
                    Text(
                        '$totalCount active client${totalCount == 1 ? '' : 's'}',
        ...
        _FilterBar(
            current: filter,
            onSelect: (s) =>
                ref.read(clientStatusFilterProvider.notifier).state = s),
    ...
    return GestureDetector(
        ...
        child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    color:
                        isSelected ? color.withOpacity(0.5) : AppColors.border,
    ...
    return Center(
        child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Text(filter != null ? filter!.emoji : '🤝',
                  style: const TextStyle(fontSize: 40)),
              const SizedBox(height: 16),
              Text(
                  filter != null
                      ? 'No ${filter!.label.toLowerCase()} clients'
                      : 'No clients yet',
