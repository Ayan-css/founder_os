...
class ContentPipelineScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ContentPipelineScreen> createState() =>
      _ContentPipelineScreenState();
}
      ...
      body: SafeArea(
        ...
        Padding(
            ...
            child: Row(children: [
              ...
              _StageCounter(
                  stage: _currentStage, count: counts[_currentStage] ?? 0),
            ])),
        ...
        Expanded(
            child: PageView.builder(
                ...
                itemBuilder: (_, i) =>
                    StageColumn(stage: ContentStage.values[i]))),
      ])),
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text('$count',
              style: AppTypography.bodySmall
                  .copyWith(color: stage.color, fontWeight: FontWeight.w700)),
        ]));
  }
}
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
        ...
        decoration: BoxDecoration(boxShadow: [
          BoxShadow(
              color: stage.color.withOpacity(0.30),
              blurRadius: 20,
              spreadRadius: -4)
        ]),
