...
class _FocusRingPainter extends CustomPainter {
  ...
  Color get _arcColor => isCompleted
      ? AppColors.success
      : isPaused
          ? AppColors.primary.withOpacity(0.45)
          : AppColors.primary;
  Color get _glowColor => isCompleted
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final tipCenter = Offset(center.dx + radius * math.cos(tipAngle),
    ...
    canvas.drawCircle(
        ...
        dotRadius + 5,
        Paint()
          ..color = _arcColor.withOpacity(0.38)
          ..maskFilter = const MaskFilter.blur(BlurStyle.normal, 7));
    canvas.drawCircle(tipCenter, dotRadius,
        Paint()..color = isCompleted ? AppColors.success : Colors.white);
    canvas.drawCircle(tipCenter - Offset(dotRadius * 0.18, dotRadius * 0.18),
        dotRadius * 0.32, Paint()..color = Colors.white.withOpacity(0.5));
  }

  @override
  bool shouldRepaint(_FocusRingPainter old) =>
      old.progress != progress ||
      old.tipPulse != tipPulse ||
