...
Future<void> showContentFormSheet(BuildContext context,
    {ContentItem? item, ContentStage? initialStage}) {
  return showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) =>
          _ContentFormSheet(item: item, initialStage: initialStage));
}
...
class _ContentFormSheetState extends ConsumerState<_ContentFormSheet> {
  ...
  Future<void> _save() async {
    ...
    if (_isEdit) {
      await notifier.updateItem(widget.item!.copyWith(
    ...
    return Container(
      ...
      child: Column(
          ...
          children: [
            ...
            Row(children: [
              Expanded(
                  child: Text(_isEdit ? 'Edit Content' : 'New Content',
            ...
            _StageGrid(
                selected: _stage, onSelect: (s) => setState(() => _stage = s)),
            const SizedBox(height: 18),
            ...
            TextField(
                ...
                decoration:
                    const InputDecoration(hintText: 'Content idea or hook...')),
            ...
            TextField(
                ...
                decoration: const InputDecoration(
                    hintText: 'Outline, hook idea, reference... (optional)')),
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text(stage.shortLabel,
                        style: AppTypography.caption.copyWith(
                            color:
                                isSelected ? stage.color : AppColors.textMuted,
                            fontWeight:
