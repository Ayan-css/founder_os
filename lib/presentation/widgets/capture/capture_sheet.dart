...
Future<void> showCaptureSheet(BuildContext context) {
  return showModalBottomSheet(context: context, isScrollControlled: true, backgroundColor: Colors.transparent, builder: (_) => const _CaptureSheet());
}
...
class _CaptureSheetState extends ConsumerState<_CaptureSheet> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _slideCtrl = AnimationController(vsync: this, duration: AppConstants.animNormal);
  ...
  @override
  void dispose() { _controller.dispose(); _slideCtrl.dispose(); super.dispose(); }
          ...
          child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                const Spacer(),
                Text('${_controller.text.length}', style: AppTypography.caption),
              ]),
              const SizedBox(height: 16),
              TextField(
                controller: _controller, autofocus: true, maxLines: 6, minLines: 3,
              ...
              const SizedBox(height: 16),
              CaptureTypeSelector(selected: _type, onSelect: (t) => setState(() => _type = t ?? CaptureType.thought)),
              ...
              SizedBox(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(colors: _controller.text.trim().isEmpty
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      onTap: _saving ? null : _save, borderRadius: BorderRadius.circular(14),
                      child: Padding(
                        padding: const EdgeInsets.symmetric(vertical: 15),
                        child: Center(child: _saving
                            ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white))
                            : Row(mainAxisSize: MainAxisSize.min, children: [
                                Icon(Icons.bolt_rounded, size: 18, color: _controller.text.trim().isEmpty ? AppColors.textDisabled : Colors.white),
                                const SizedBox(width: 8),
                                Text('Capture it', style: AppTypography.bodyLarge.copyWith(
                                  color: _controller.text.trim().isEmpty ? AppColors.textDisabled : Colors.white,
